class GroupMembersController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to group_members_path, status: :see_other, notice: "Group member was successfully destroyed." }
  ...
  private
    ...
    def group_member_params
      params.require(:group_member).permit(:user_id, :family_group_id, :role)
    end
end
